...
class ObjectiveEvaluator:
    ...
    def evaluate_architecture(self) -> Dict[str, Any]:
        """评估架构设计"""
        agents_dir = self.root_dir / 'agentorchestra' / 'agents'
        core_dir = self.root_dir / 'agentorchestra' / 'core'
        tools_dir = self.root_dir / 'agentorchestra' / 'tools'
    ...
    def evaluate_code_quality(self) -> Dict[str, Any]:
        ...
        core_dir = self.root_dir / 'agentorchestra' / 'core'
        context_dir = self.root_dir / 'agentorchestra' / 'context'
    ...
    def evaluate_error_handling(self) -> Dict[str, Any]:
        ...
        has_custom_exceptions = (agentorchestra_dir / 'core' / 'exceptions.py').exists()
        if has_custom_exceptions:
            score += 0.5
            issues.append('已实现自定义异常 (exceptions.py)')

        core_agent = agentorchestra_dir / 'core' / 'agent.py'
        ...
        # 检查工具错误码体系
        error_codes = agentorchestra_dir / 'tools' / 'builtin' / 'error_code.py'
