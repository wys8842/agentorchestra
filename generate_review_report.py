...
def analyze_agents_module():
    ...
    agents_dir = Path("agentorchestra/agents")
    core_dir = Path("agentorchestra/core")
    issues = []
    score = 9.0
...
def analyze_tools_module():
    ...
    try:
        base_py = Path("agentorchestra/tools/base.py").read_text(encoding="utf-8")
        registry_py = Path("agentorchestra/tools/registry.py").read_text(encoding="utf-8")
        circuit_py = Path("agentorchestra/tools/circuit_breaker.py").read_text(encoding="utf-8")
    except:
        return [], 6.5
...
def analyze_core_module():
    ...
    try:
        agent_py = Path("agentorchestra/core/agent.py").read_text(encoding="utf-8")
    except:
        return [], 5.5
